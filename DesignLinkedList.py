...
class MyLinkedList:
    ...
    def addAtTail(self, val: int) -> None:
        # we can use the append() to add at the end of the list
        self.list.append(val)
        

    def addAtIndex(self, index: int, val: int) -> None:
        # we need t0 check if the index is within the bounds of the list
        # if yes then we will insert using insert() at that index 
